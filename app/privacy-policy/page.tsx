...
export const metadata: Metadata = {
  ...
  description: "Falahsys Privacy Policy - How we collect, use, and protect your information.",
};
      ...
      <Container className="max-w-3xl">
        ...
        <div className="max-w-none space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <p>Falahsys does not sell, trade, or rent personal information to third parties. We may share information only when necessary:</p>
            <ul className="list-disc pl-6 space-y-1 mt-2">
